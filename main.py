...
"""
y = pd.read_csv('ign.csv', index_col=2)
...
"""
scorr_und_2 = x[x['score'] < 2]
perf_scorr = x[x['score'] == 10]
...
"""
scorr_und_2.to_csv('trash')
perf_scorr.to_csv('perfect')
